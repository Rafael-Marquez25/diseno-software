...
void Admin::showMenu(sqlite3* db){ // Admin menu
    system("clear");
    int userSelection;
    std::cout << "=== Menu Admin ===\n" 
    <<           "1. Crear Doctor.\n"
...
void Admin::showMedicsList(sqlite3* db){
    const char* sql;
...
void Admin::createMedic(sqlite3* db){
    showMedicsList(db);
...
void Admin::assignScheduleToMedic(sqlite3* db){
